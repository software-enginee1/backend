...
<template>
  <div class="bg-indigo-500">
    <div class="container relative">
      ...
      <nav v-if="showMobileNav" class="md:hidden absolute top-0 left-0 h-screen pb-6 w-screen bg-indigo-500 flex items-center justify-center">
        <div class="flex flex-col items-center justify-center gap-8">
          ...
          <router-link to="/profile" v-if="user" class="link link-mobile">
            Profile
          </router-link>
          <div
            @click="user ? Logout() : router.push('/register')"
